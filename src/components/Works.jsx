    ...
    <>
      < div className='relative'>
        ...
        <div className='w-full flex'>
          ...
          >
           These projects showcase my hands-on experience through real-world implementations. Each one includes a short description with links to the source code and live demo, reflecting my problem-solving skills, technical versatility, and project management capabilities.
          </motion.p>
